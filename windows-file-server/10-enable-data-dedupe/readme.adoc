...
. Continue and wait until the optimization job completes, periodically executing the *Get-FSxDedupStatus* command. This will be indicated by the *LastOptimizationResultMessage* value changing to *The operation completed successfully*.
