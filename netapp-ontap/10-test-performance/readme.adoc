...
[source,bash]
----
sudo mount -t nfs -o vers=4.2,nconnect=16 ${NFSENDPOINT}:/vol1_primary ${MOUNTPOINT}
sudo mount -t nfs -o vers=4.2,nconnect=16 ${NFSENDPOINT}:/vol1_primary_clone1 ${CLONEDIR}
----
+
