...
. *_Return_* to the Session Manager session of your *FSx for ONTAP Workshop Linux instance-<Region>* and run the script below to create a 1 GB file.
+
...
. On the *FSx for ONTAP Workshop Linux instance-<Region>* instance change directory to the *${MOUNTPOINT}/1GB/file_srcdir/<your-machine-id>/thrd_00/d_000/* directory and copy the file name of one of the files in this directory to your local text editor for the next steps.
