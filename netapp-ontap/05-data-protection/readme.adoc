...
. Go to the link:https://console.aws.amazon.com/fsx/[Amazon FSx] console, *_Click_* the *_File system ID_* of your *primary* Amazon FSx for NetApp ONTAP file system.
