...
----
+
. *Run* the following command to check if the share was created successfully. 
+
[source,bash]
----
...
=== Map a share to the Windows instance
...
image::flexclone.jpg[link=../05-flexclone/, align="left",width=420]
